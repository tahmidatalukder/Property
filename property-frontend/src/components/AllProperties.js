    ...
    return (
        <div>
            ...
            <div className="filter-container">
                <input type="text" name="type" placeholder="Type (Flat, Plot...)" onChange={handleFilterChange} />
                <input type="text" name="location" placeholder="Location" onChange={handleFilterChange} />
                <input type="text" name="purpose" placeholder="Purpose (Sell, Rent...)" onChange={handleFilterChange} />
            </div>
